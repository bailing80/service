...
public class SynQueryDemo {
	...
	public static void main(String[] args) {
		String key = "nDyKLnYO2555";	//贵司的授权key
		String customer = "45C58167AC05BEB4B6E7B8132B2CC243";//贵司的查询公司编号
		String com = "yunda";			//快递公司编码
		String num = "3950055201640";	//快递单号
		String phone = "13691226509";	//手机号码后四位
		String from = "北京市丰台区";			//出发地
		String to = "北京丰台区外环西路26号";			//目的地
