...
import com.yian.admin.model.SysLog;
import com.yian.admin.sevice.SysLogService;
import com.yian.admin.util.HttpUtils;
import com.yian.admin.util.IPUtils;
...
public class SysLogAspect {
	...
	@Pointcut("execution(* com.yian.admin.*.service.*.*(..))")
